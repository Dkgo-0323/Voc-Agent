...
CASES = (
    ...
    _case("SG45", GoldenCategory.ABSTENTION, "Find Delta 2 evidence for ISO week 202453.", required=(Tool.RAG,), allowed=(Tool.RAG,), skus=(DELTA_2,), weeks=(202453,), answer=("Reject the invalid ISO week safely and do not search.",), notes="Week 202453 is invalid and must fail validation before external calls."),
