...
if not local_path:
    ...
    print(f"手动下载地址: https://huggingface.co/datasets/{REPO_ID}/resolve/main/raw_review_{CATEGORY}.jsonl")
    exit(1)
...
# 命中统计结构
hits = {asin: {"sku": sku, "count": 0, "samples": []} 
        for asin, sku in TARGET_ASINS.items()}
total_lines = 0
